...
public class TestMobileForm extends BaseRunner {
    ...
    public void testSecond() {
        ...
        driver.findElement(By.name("fio")).sendKeys("оналрпстачь");
        driver.findElement(By.name("phone_mobile")).click();
        driver.findElement(By.name("phone_mobile")).clear();
        driver.findElement(By.name("phone_mobile")).sendKeys("+7(537) 837-68-");
        driver.findElement(By.name("email")).click();
        driver.findElement(By.name("email")).clear();
        driver.findElement(By.name("email")).sendKeys("овлровс п");
